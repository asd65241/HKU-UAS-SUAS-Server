...
class TestMissionScoring(TestCase):
    ...
    def test_total(self):
        ...
        mission_evaluation.score_team(self.eval)
        self.assertAlmostEqual(0.2851666666666667, self.eval.score.score_ratio)
...
class TestMissionEvaluation(TestCase):
    ...
    def test_evaluate_teams(self):
        ...
        self.assertLess(feedback.uas_telemetry_time_avg_sec, 1)
        ...
        self.assertTrue(auto_flight.HasField('telemetry_prerequisite'))
        self.assertTrue(auto_flight.telemetry_prerequisite)
        ...
        self.assertGreater(score.score_ratio, 0)
